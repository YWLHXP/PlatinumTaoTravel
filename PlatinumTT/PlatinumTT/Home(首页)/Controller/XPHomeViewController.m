...
@property (nonatomic, strong) HomeWebViewController *handleWebView;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 3) {
        ...
        if (indexPath.row == 0) {
            ...
            //加线
            UIView *horizontalLine = [[UIView alloc]initWithFrame:CGRectMake(0, 0, XPScreenWidth, 1)];
        ...
        if (indexPath.row == 1) {
            //加线
            UIView *horizontalLine = [[UIView alloc]initWithFrame:CGRectMake(0, CellHeight200/3-1, XPScreenWidth, 1)];
            horizontalLine.backgroundColor = [UIColor lightGrayColor];
            UIView *horizontalLine1 = [[UIView alloc]initWithFrame:CGRectMake(0, CellHeight200/3*2-1, XPScreenWidth, 1)];
            horizontalLine1.backgroundColor = [UIColor lightGrayColor];
            UIView *horizontalLine2 = [[UIView alloc]initWithFrame:CGRectMake(0, CellHeight200-1, XPScreenWidth/5*3, 1)];
            horizontalLine2.backgroundColor = [UIColor lightGrayColor];
            
            UIView *verticalLine = [[UIView alloc]initWithFrame:CGRectMake(XPScreenWidth/5-1, 0, 1, CellHeight200)];
            verticalLine.backgroundColor = [UIColor lightGrayColor];
            UIView *verticalLine1 = [[UIView alloc]initWithFrame:CGRectMake(XPScreenWidth/5*2-1, 0, 1, CellHeight200)];
            verticalLine1.backgroundColor = [UIColor lightGrayColor];
            UIView *verticalLine2 = [[UIView alloc]initWithFrame:CGRectMake(XPScreenWidth/5*3-1, 0, 1, CellHeight200)];
            verticalLine2.backgroundColor = [UIColor lightGrayColor];
            UIView *verticalLine3 = [[UIView alloc]initWithFrame:CGRectMake(XPScreenWidth/5*4-1, 0, 1, CellHeight200/3*2)];
        ...
        if (indexPath.row == 1) {
            ...
            //加线
            UIView *horizontalLine = [[UIView alloc]initWithFrame:CGRectMake(0, CellHeight150-1, XPScreenWidth, 1)];
            horizontalLine.backgroundColor = [UIColor lightGrayColor];
            [view addSubview:horizontalLine];
        }
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        ...
        if (indexPath.row == 3) {
            ...
            //加线
            UIView *horizontalLine = [[UIView alloc]initWithFrame:CGRectMake(0, CellHeight100-1, XPScreenWidth, 1)];
            horizontalLine.backgroundColor = [UIColor lightGrayColor];
            [view addSubview:horizontalLine];
            [view addSubview:imageView];
        ...
        UIView *horizontalLine = [[UIView alloc]initWithFrame:CGRectMake(0, 0, XPScreenWidth, 1)];
        horizontalLine.backgroundColor = [UIColor lightGrayColor];
        UIView *horizontalLine1 = [[UIView alloc]initWithFrame:CGRectMake(0, CellHeight150-1, XPScreenWidth, 1)];
        horizontalLine1.backgroundColor = [UIColor lightGrayColor];
        UIView *verticalLine = [[UIView alloc]initWithFrame:CGRectMake(XPScreenWidth/3-1, 0, 1, CellHeight150)];
        verticalLine.backgroundColor = [UIColor lightGrayColor];
        UIView *verticalLine1 = [[UIView alloc]initWithFrame:CGRectMake(XPScreenWidth/3*2-1, 0, 1, CellHeight150)];
        verticalLine1.backgroundColor = [UIColor lightGrayColor];
